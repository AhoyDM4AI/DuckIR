...
#include "duckdb/runtime/default/execution/operator/projection/physical_projection.hpp"
#include "duckdb/runtime/default/execution/operator/filter/physical_filter.hpp"
#include "duckdb/runtime/default/execution/operator/scan/physical_table_scan.hpp"
#include "duckdb/runtime/default/execution/operator/schema/physical_create_art_index.hpp"
#include "duckdb/runtime/default/execution/operator/order/physical_order.hpp"
...
unique_ptr<PhysicalOperator> PhysicalPlanGenerator::CreatePlan(LogicalCreateIndex &op) {
	// generate a default plan for the parallel index creation which consists of the following operators
	...
	// actual default create index operator
