...
if '--extended' in sys.argv:
    ...
    main_header_files += [
        ...
        for x in [
            ...
            'duckdb/runtime/default/storage/object_cache.hpp',
            'duckdb/planner/table_filter.hpp',
            "duckdb/runtime/default/storage/statistics/base_statistics.hpp",
            ...
            "duckdb/runtime/default/common/types/vector/vector_cache.hpp",
            "duckdb/common/string_map_set.hpp",
            "duckdb/planner/filter/null_filter.hpp",
            "duckdb/runtime/default/common/arrow/arrow_wrapper.hpp",
            "duckdb/runtime/default/common/file_system/hive_partitioning.hpp",
            "duckdb/common/union_by_name.hpp",
            "duckdb/planner/operator/logical_get.hpp",
            "duckdb/runtime/default/common/file_system/compressed_file_system.hpp",
        ]
    ]
